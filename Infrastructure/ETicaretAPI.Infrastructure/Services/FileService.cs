...
public class FileService : IFileService
{
    ...
    public async Task<List<(string fileName, string path)>> UploadAsync(string path, IFormFileCollection files)
    {
        ...
        {
            return datas;
            //todo eğer ki yukarıdaki if geçerli değilse burada dosyaların sunucuda yüklenirken hata alındığına dair uyarıcı bir ex oluşturulup fırlatılması gerekiyor.
        }
        return null;
    }
}
